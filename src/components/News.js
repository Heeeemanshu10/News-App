...
export default class News extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=f2b970b162d74d11b4ac8896432a820a&page=1&pageSize=20"
    ...
    handlePrevClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=f2b970b162d74d11b4ac8896432a820a&page=${this.state.page - 1}&pageSize=20`
        let data = await fetch(url)
        let parsedData = await data.json()
    ...
    render() {
        return (
            <div className='container my-4'>
                <h1>News Junkie top headlines</h1>
                <div className='row'>
